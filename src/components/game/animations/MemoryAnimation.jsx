 ...
 * Orquesta el grid de 16 cartas y el sistema de puntuación
 */
    ...
    if (status === 'spin' || status === 'round_result') {
        return (
            <div className="memory-game-container" style={{
                ...
                {/* Badge de Memorización - ARRIBA del scoreboard */}
                <AnimatePresence>
                    {isMemorizing && (
                        <motion.div
...
MemoryAnimation.propTypes = {
    ...
    gameState: PropTypes.shape({
        ...
        flippedIndices: PropTypes.arrayOf(PropTypes.number),
        matchedIndices: PropTypes.arrayOf(PropTypes.number),
        memoryScores: PropTypes.shape({
            player: PropTypes.number,
            opponent: PropTypes.number,
        }),
        timeLeft: PropTypes.number,
        memoryPhase: PropTypes.oneOf(['memorize', 'playing', 'result']),
        memorizePhaseNumber: PropTypes.number,
        memorizeTimeLeft: PropTypes.number,
        revealedIndices: PropTypes.arrayOf(PropTypes.number)
    }),
